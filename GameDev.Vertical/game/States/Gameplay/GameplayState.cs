...
using VerticalGame.Engine.Objects.Collisions;
using VerticalGame.Engine.States;
using VerticalGame.Input;
using VerticalGame.Levels;
using VerticalGame.Objects;
using VerticalGame.Objects.Text;
using VerticalGame.States.Gameplay;
using VerticalGame.States.Particles;
...
namespace VerticalGame.States
{
    public class GameplayState : BaseGameState
    {
        ...
        private const string StatFont = "Fonts/Stats";
        ...
        public override void LoadContent()
        {
            ...
            _statsText = new StatsObject(LoadFont(StatFont));
            _statsText.Position = new(10, 10);
